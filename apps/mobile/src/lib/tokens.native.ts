...
/**
 * SecureStore throws rather than returning null when the keychain is unavailable. A read
 * failure has to look like "signed out" instead of rejecting, or the launch splash would
 * hang.
 */
