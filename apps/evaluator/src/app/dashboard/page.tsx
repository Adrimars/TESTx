...
function DialogSection({
  ...
  return (
    <section className="border-t border-border pt-5 first:border-t-0 first:pt-0">
      <h3 className="mb-3 text-meta uppercase text-muted-foreground">
        {title}
      </h3>
      {children}
    </section>
...
export default function DashboardPage() {
  ...
  async function saveProfile() {
    if (!editAge) {
      setEditError("Please select your age.");
      return;
    }
    if (!editCountry) {
      setEditError("Please select your country.");
      return;
    }
    setEditSaving(true);
    setEditError("");
    ...
    <div className="space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Pick up your next test and track your points.
        </p>
      </div>
            ...
            <CardContent className="space-y-5 p-5 sm:p-6">
              ...
              {!loading && nextTest && (
                <>
                  ...
                  <MotionPress className="w-full sm:inline-block sm:w-auto">
                    <Button
                      size="lg"
                      className="w-full"
          ...
          <MotionLift>
            <Card>
              <CardContent className="p-5">
                ...
                <p className="mt-1.5 text-stat tabular-nums text-primary">
                  {balance}
                </p>
                <Button
                  variant="secondary"
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <Field label="City">
                <Combobox
                  ...
                  placeholder={
                    editCountry ? "Select city…" : "Select country first…"
                  }
