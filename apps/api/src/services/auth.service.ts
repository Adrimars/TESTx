  ...
  return {
    ...
    evaluatorProfile: user.evaluatorProfile
      ? {
          ...
          nativeLanguage: user.evaluatorProfile.nativeLanguage,
          foreignLanguages: user.evaluatorProfile.foreignLanguages,
          occupation: user.evaluatorProfile.occupation,
          educationLevel: user.evaluatorProfile.educationLevel,
